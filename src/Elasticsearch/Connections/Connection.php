...
use ElasticsearchV2\Common\Exceptions\AlreadyExpiredException;
use ElasticsearchV2\Common\Exceptions\BadRequest400Exception;
use ElasticsearchV2\Common\Exceptions\Conflict409Exception;
use ElasticsearchV2\Common\Exceptions\Curl\CouldNotConnectToHost;
use ElasticsearchV2\Common\Exceptions\Curl\CouldNotResolveHostException;
use ElasticsearchV2\Common\Exceptions\Curl\OperationTimeoutException;
use ElasticsearchV2\Common\Exceptions\Forbidden403Exception;
use ElasticsearchV2\Common\Exceptions\MaxRetriesException;
use ElasticsearchV2\Common\Exceptions\Missing404Exception;
use ElasticsearchV2\Common\Exceptions\NoDocumentsToGetException;
use ElasticsearchV2\Common\Exceptions\NoShardAvailableException;
use ElasticsearchV2\Common\Exceptions\RequestTimeout408Exception;
use ElasticsearchV2\Common\Exceptions\RoutingMissingException;
use ElasticsearchV2\Common\Exceptions\ScriptLangNotSupportedException;
use ElasticsearchV2\Common\Exceptions\ServerErrorResponseException;
